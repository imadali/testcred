...
********************************************************************************/
 ...
 if(file_exists('custom/metadata/k_evacampaignarticles_contactsMetaData.php')) { include('custom/metadata/k_evacampaignarticles_contactsMetaData.php'); } if(file_exists('custom/metadata/k_evacampaignarticles_leadsMetaData.php')) { include('custom/metadata/k_evacampaignarticles_leadsMetaData.php'); } 