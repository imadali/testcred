...
$dictionary['Contract']['fields']['name']['formula'] = 'ifElse(equal($provider_id_c,"bank_now_flex"),concat($lead_first_name," ",getDropdownValue("dotb_credit_provider_list",$provider_id_c)," ",toString($credit_amount_flex)," ",toString($interest_rate_flex)," ",toString($credit_duration_flex)," ",ifElse(equal($ppi_flex,true),"NOPPI","PPI")," ",toString(today())," Vertrag"),concat($lead_first_name," ",getDropdownValue("dotb_credit_provider_list",$provider_id_c)," ",toString($credit_amount_c)," ",toString($interest_rate_c)," ",toString($credit_duration_c)," ",ifElse(equal($ppi_c,0),"NOPPI","PPI")," ",toString(today())," Vertrag"))';
