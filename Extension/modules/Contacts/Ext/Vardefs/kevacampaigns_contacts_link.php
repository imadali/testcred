...
********************************************************************************/
 ...
 $dictionary['Contact']['fields']['kevacampaigns_contacts_link']=array( 'name' => 'kevacampaigns_contacts_link', 'type' => 'link', 'relationship' => 'kevacampaigns_contacts', 'link_type' => 'one', 'source' => 'non-db', 'vname' => 'LBL_KEVACAMPAIGN_CONTACTS', 'duplicate_merge'=> 'disabled', );