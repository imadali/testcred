<?php
$dictionary['Contact']['fields']['correspondence_address_c_o']=array (
      'required' => false,
   ...
   $dictionary['Contact']['fields']['correspondence_address_street'] =array (
     ...
     $dictionary['Contact']['fields']['correspondence_address_city'] = array (
     ...
     $dictionary['Contact']['fields']['correspondence_address_postalcode'] = array (
    ...
    $dictionary['Contact']['fields']['correspondence_address_country'] = array (
      ...
      'calculated' => true,
      'formula' => 'ifElse(equal(getDropdownValue("dotb_postcode_list",$correspondence_address_postalcode),""),$correspondence_address_country,getDropdownValue("dotb_postcode_list",$correspondence_address_postalcode))',
      'required' => false,
      'enforced' => false,
    );
 ?>