({
    ...
    initialize: function(options) {
       ...
       app.alert.show('campaign-fetch', {
                level: 'process',
                title: 'Fetching Evalanche Campaigns...',
                autoClose: true,
        });
        ...
        /**
         * CRED-971 : Show Evalanche Campaigns related to Contact
         * instead of Sugar campaigns
         */
        var evaCampaigns = this.model.getRelatedCollection('kevacampaigns_contacts_link');
        evaCampaigns.fetch({
            relate: true,
            ...
            error : function(){
                ...
                app.alert.show('no-active-campign', {
                    level: 'error',
                    title: 'Fetching Evalanche Campaigns Failed',
                    autoClose: true,
                });
                self.renderDocTrackingView();
            }
