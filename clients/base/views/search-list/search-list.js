...
({
    ...
    parseModels: function(models) {
        ...
        _.each(models, function(model) {
            ...
            /**
             * CRED-905: Updates in upgraded view
             */
            ...
            /*
                 * RT Customization Start
                 */
                if(model.module=='Leads'){
                model.status_label  = app.lang.get('LBL_CREDIT_REQUEST_STATUS_ID', model.module);
                var val = model.get('credit_request_status_id_c');
                var status_dom=app.lang.getAppListStrings('dotb_credit_request_status_list');
		model.status_value = status_dom[val];
                }
                /*
