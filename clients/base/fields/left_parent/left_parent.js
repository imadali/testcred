    ...
    _render: function() {
        ...
        if (this.tplName === 'edit') {
            ...
            if (this.model.get(this.def.type_name) !== domParentTypeVal) {
                ...
                /**
                * setDefaultAttribute Removed in 7.8.0.0 as given in this link http://support.sugarcrm.com/Documentation/Sugar_Versions/7.8/Ent/Sugar_7.8.0.0_Release_Notes/#Development_Changes
                */
    ...
    setValue: function(model) {
        ...
        if (app.acl.hasAccess(this.action, module, this.model.get('assigned_user_id'), this.name)) {
            if (module) {
                ...
                /**
                * removeDefaultAttribute Removed in 7.8.0.0 as given in this link http://support.sugarcrm.com/Documentation/Sugar_Versions/7.8/Ent/Sugar_7.8.0.0_Release_Notes/#Development_Changes
                */
                if (this._defaults) {
