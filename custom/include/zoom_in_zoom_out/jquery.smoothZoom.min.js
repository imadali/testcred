...
(function(e, t, n) {
    function i(t, n) {
        ...
        if(u.initial_ZOOM!==0) {
            ...
            this.init_zoom = u.initial_ZOOM;
        }
        this.transformSet = u.transformSet;
        ...
        if (!this.bu_icon) {
            ...
            if (this.bu_icon == "none") {
                this.bu_icon = "custom/include/zoom_in_zoom_out/icons.png"
            }
            l.remove()
        }
        ...
        this.imgList = [{
            loaded: false,
            src: this.bu_icon || "custom/include/zoom_in_zoom_out/icons.png"
        }, {
            loaded: false,
    ...
    i.prototype = {
        ...
        setLocation: function(t) {
            ...
            if (r.hasClass("mark")) {
                ...
                if (p !== "") {
                    ...
                    var m = e('<div style="position: absolute; left: ' + -i + "px; top: " + -a + "px; width: " + (i - parseInt(v.css("padding-left"))) * 2 + "px; height:" + (a - parseInt(v.css("padding-top"))) * 2 + "px; background-color: " + p + ';"><div class="rotate-custom"></div></div>').appendTo(r);
                    if (d) {
                        m.css("opacity", d)
                    }
                }
        ...
        Animate: function() {
            ...
            if (o && e.transformSet) {
                ...
                if(!e.transformSet){
                    e.$image.css(o, "translate(0px, 0px)");
                }
                e.transformSet =  true;
            }
            if (e.$loc_cont) {
