({
                        ...
                        success: _.bind(function (result) {
                            ...
                            self.model.fetch({
                                success: function () {
                                    ...
                                    /* refresh applications subpanel if status was 04_documents_received*/
                                    if(previous_status == '04_documents_received'){
                                        var applicationsCollection = self.model.getRelatedCollection('leads_opportunities_1');
                                        applicationsCollection.fetch({relate: true});
                                    }
									
                                    if (self.model.get("credit_request_status_id_c") == '09_payout') {
    ...
    createContract: function (response) {
        ...
        modelPrefil.set({
            ...
            //dotb_soko_c: self.model.get('dotb_soko_c'),
            //credit_amount_c: response['credit_amount'],
            //credit_duration_c: response['duration'],
            credit_amount_c: response['customer_credit_amount_c'],
            credit_duration_c: response['customer_credit_duration_c'],
            ...
            status: 'inprogress',
            create_contact: true,
            //interest_rate_c: response['interest_rate'],
            interest_rate_c: response['customer_interest_rate_c'],
            lead_first_name: self.first_name + ' ' + self.last_name,
            customer_credit_amount_c: response['customer_credit_amount_c'],
            customer_credit_duration_c: response['customer_credit_duration_c'],
            customer_interest_rate_c: response['customer_interest_rate_c'],
            customer_ppi_c: response['customer_ppi_c'],
            contract_ppi_plus: response['contract_ppi_plus'],
            contract_transfer_fee: response['contract_transfer_fee'],
            provider_id_c: response['provider_id_c'],
            dotb_soko_c: response['soko'],
