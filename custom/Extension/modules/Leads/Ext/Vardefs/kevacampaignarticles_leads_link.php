...
********************************************************************************/
 ...
 $dictionary['Lead']['fields']['kevacampaignarticles_leads_link']=array( 'name' => 'kevacampaignarticles_leads_link', 'type' => 'link', 'relationship' => 'kevacampaignarticles_leads', 'link_type' => 'one', 'source' => 'non-db', 'vname' => 'LBL_KEVACAMPAIGNARTICLE_LEADS', 'duplicate_merge'=> 'disabled', );