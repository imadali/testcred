...
********************************************************************************/
 ...
 if(file_exists('custom/metadata/k_evacampaigns_contactsMetaData.php')) { include('custom/metadata/k_evacampaigns_contactsMetaData.php'); } if(file_exists('custom/metadata/k_evacampaigns_leadsMetaData.php')) { include('custom/metadata/k_evacampaigns_leadsMetaData.php'); } 